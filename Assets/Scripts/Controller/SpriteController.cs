...
public class SpriteController : MonoBehaviour
{
    ...
    // MySprite = SpriteController.instance.LoadNewSprite(FilePath, [PixelsPerUnit (optional)])

    private static SpriteController _instance;
    ...
    public static SpriteController instance
    {
        get
        {
            ...
            if (_instance == null)
                _instance = GameObject.FindObjectOfType<SpriteController>();
            return _instance;
        }
    }
